...
export class Logger {
	static log (content: string, type = "info") {
		...
		case "db": {
			return console.log(`${chalk.hex('#000000').bgHex('#FFFF00')(` | FIREBASE     ${chalk.hex('#000000').bgHex('#808080')(`[${date}]`)} `)} ${chalk.hex('#FFFF00')(content)}`);
		}
		case "web": {
			return console.log(`${chalk.hex('#000000').bgHex('#00FF00')(` | WEBSITE     ${chalk.hex('#000000').bgHex('#808080')(`[${date}]`)} `)} ${chalk.hex('#00FF00')(content)}`);
		}
